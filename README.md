<h1>如果IDM提示403错误，则是UA配置不正确导致，在IDM中 选项 -> 下载 -> 手动添加任务时使用的用户代理（UA）-> 填入<span style="color:#2800fc">netdisk;7.2.6.2;PC</span>，看不见插件<span style="color:red"> 请尝试停掉其他插件或更换浏览器(能解决99%问题) </span></h1>
